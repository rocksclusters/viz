...
//-----------------------------------------------------------------------------
//
// $Id: screen.h,v 1.1 2004/08/09 19:14:42 mjk Exp $
//
...
//
// $Log: screen.h,v $
// Revision 1.1  2004/08/09 19:14:42  mjk
// increase max res
//
...
//#ifdef SOLARIS
#define MAXVIDWIDTH    10*1280  // Needed for fullscreen mode on Sun monitors.
#define MAXVIDHEIGHT   10*1024  // 
//#else
//#define MAXVIDWIDTH    1024  // dont set this too high because actually
//#define MAXVIDHEIGHT    768  // lots of tables are allocated with the MAX size.
//#endif
