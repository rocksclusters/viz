...
static XtResource appDataResourceList[] = {
  ...
  ,{"offsetX", "offsetX", XtRInt, sizeof(int),
   XtOffsetOf(AppData, offsetX), XtRImmediate, (XtPointer) 0},

  {"offsetY", "offsetY", XtRInt, sizeof(int),
   XtOffsetOf(AppData, offsetY), XtRImmediate, (XtPointer) 0}
#endif
...
#ifdef ROCKS
  ,{"-offsetX",         "*offsetX",     XrmoptionSepArg, 0},
  {"-offsetY",         "*offsetY",     XrmoptionSepArg, 0}
#endif 
